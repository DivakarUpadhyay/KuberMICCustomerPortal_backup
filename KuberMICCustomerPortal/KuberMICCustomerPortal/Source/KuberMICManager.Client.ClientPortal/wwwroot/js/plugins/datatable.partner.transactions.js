 ...
 *
 * Pages.More.Partner.PartnerTransactions page content scripts. Initialized from scripts.js file.
 *
 *
 */

class PartnerTransactions extends DataTablePluginBase {
    _createInstance() {
        const _this = this;
        ...
        this._datatable = jQuery('#datatableBoxed').DataTable({
            ...
            columns: [{ data: 'Date' }, { data: 'Pool' }, { data: 'Partner' }, { data: 'Name' }, { data: 'Account Type' }, { data: 'Investment Type' }, { data: 'Certificate' }, { data: 'Reference' }, { data: 'Description' }, { data: 'Code' }, { data: 'Drip' }, { data: 'Ach' }, { data: 'Shares' }, { data: 'Amount' }, { data: 'Full Name' }, { data: 'SIN' }, { data: 'Business Name' }, { data: 'Joint Partner Names' }, { data: 'Street' }, { data: 'City' }, { data: 'Province' }, { data: 'Postal Code' }, { data: 'Notes' }],
            paging: true,
            pageLength: 25,
            language: {
