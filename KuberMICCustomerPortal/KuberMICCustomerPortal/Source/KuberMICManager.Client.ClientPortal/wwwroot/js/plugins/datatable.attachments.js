 ...
 * Loan Attachments
 *
 * Pages.Loan.Attachments page content scripts. Initialized from scripts.js file.
 *
 *
 */

class Attachments extends DataTablePluginBase {
    _createInstance() {
        const _this = this;
        this._staticHeight = 30;
        this._datatable = jQuery('#datatableBoxed_Attachments').DataTable({
            ...
            columns: [{ data: 'Description' }, { data: 'Added' }],
            paging: true,
            pageLength: 25,
            language: {
